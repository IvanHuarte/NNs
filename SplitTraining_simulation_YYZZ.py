...
sizes = config['sizes']
field_list = config['CM'][cm_model_name]['field_list']                # Lattice and coupling model
coupling_list = config['CM'][cm_model_name]['coupling_list']
...
for i, size in enumerate(sizes):
    ...
    for fields in field_list:
        ...
        for couplings in coupling_list:
            ...
            config['CM'][cm_model_name]['fields']=fields
            config['CM'][cm_model_name]['couplings']=couplings
            config['size']=size
            ...
            for sweeps in schedule['sweeps']:
                ...
                _kwargs['size']=size ; _kwargs['fields']=fields
