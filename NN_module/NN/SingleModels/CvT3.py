...
class StageBlock(nn.Module):
    """
    Implementation of a stage block for CvT3.
...
class CvT3(nn.Module):
    """
    Convolutional Vision Transformer (CvT3) implementation.
    ...
    Inputs:
        n_stages: Number of stages in the CvT3 model.
