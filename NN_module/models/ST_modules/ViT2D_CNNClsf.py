...
class ViT2D_CNNClsf_Worker(nn.Module):
    """
    ...
    "Phase settings CNNClsf"
    cnnclsf_channels: Tuple = (32,)
    n_classes: int = 2
...
class ViT2D_CNNClsf_2D(nn.Module):
...
class ViT2D_CNNClsf_Z2(nn.Module):
